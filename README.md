...
- [hooker.nvim](https://github.com/Finnian-Walsh/hooker.nvim)
...
- [plugin-view.nvim](https://github.com/Finnian-Walsh/plugin-view.nvim)
...
A configuration for the popular terminal workspace, [Zellij](https://zellij.dev/) somewhat diverged from the default
