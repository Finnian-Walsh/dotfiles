...
local function snake(opts)
    ...
    if #args > 2 then
        vim.notify("Unknown option: ", vim.log.levels.ERROR)
    end
    ...
    elseif difficulty == "hard" then
        ...
        vim.notify("Unknown difficulty: " .. difficulty, vim.log.levels.ERROR)
        return
    end
    ...
    elseif game_size == "large" then
        ...
        vim.notify("Unknown game size: " .. game_size, vim.log.levels.ERROR)
        return
    end
