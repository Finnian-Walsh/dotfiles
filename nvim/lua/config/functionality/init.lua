...
safe_loader.load("config.functionality.neo-tree")
...
safe_loader.load("config.functionality.telescope")
safe_loader.load("config.functionality.todo-comments")
safe_loader.load("config.functionality.toggleterm")
safe_loader.load("config.functionality.undotree")
